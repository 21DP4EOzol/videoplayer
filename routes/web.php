...
Route::get('/videos/{id}', [\App\Http\Controllers\VideosController::class, 'show'])->name('video.show');
Route::post('public/videos', [VideosController::class, 'store'])->name('videos.store');
