                ...
                <div class="flex mt-1.5">
                    ...
                    <div class="px-1.5 text-white mt-1">
                        ...
                        <div class="text-[14px] text-gray-300 font-extrabold flex gap-1 items-center cursor-pointer">
                            {{ user.substring(0, 30) }} <CheckCircle fillColors="#888888" :size="17"/>
                        </div>
...
<script setup>
    ...
    let video = ref(null)
    let width = ref(document.documentElement.clientWidthull)

    onMounted(() =>{
        window.addEventListener('resize', ()=> {
            width.auth = document.documentElement.clientWidth;
        })
    })
