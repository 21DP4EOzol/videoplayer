                ...
                <div class="flex items-center mb-4"></div>
                    ...
                    <div class="pl-2 mt-1">
                        <div class="text-white text-lg font-extrabold flex items-center">
                            {{ video.user }} <CheckCircle fillColors="#888888" :size="17"/>
                        </div>
                ...
                <div v-for="vid in recommendedVideos" :key="vid">
                    ...
                    <div class="bg-[#3F3F3F] rounded-lg w-full p-3 text-white">
                        ...
                        <div class="text-sm font-extrabold">
                            Lorem Ipasum is simply dumy text of the printing and typesetting industry. Lorem Lorem Ipasum is simply dumy text of the printing and typesetting industry. Lorem
                        </div>
                    </div>
